...
class BranchesTableTest extends TableTestBase {
    ...
    void testReadWithBranchNameEqualFilter() throws Exception {
        ...
        // a non-existing branch should yield empty
    ...
    void testReadWithBranchNameNotEqualFilter() throws Exception {
        // Before post-filter was implemented, scan only handled Equal / OR-IN on branch_name and
        // any other predicate (e.g. <>) was silently dropped, returning an empty result. This
        // case verifies the post-filter path properly evaluates such predicates.
        table.createBranch("my_branch1", "2023-07-17");
        table.createBranch("my_branch2", "2023-07-18");
        table.createBranch("my_branch3", "2023-07-18");
